...
#if ANY(EXTENSIBLE_UI, IS_NEWPANEL, EMERGENCY_PARSER, HAS_ADC_BUTTONS, HAS_DWIN_E3V2) || TRONXY_UI
 ...
 */
  ...
  #elif HAS_DRIVER(HBS57)
    #define MINIMUM_STEPPER_PULSE 2 //HBS57需要最小1.5us的最小脉冲时间,这里取整2us
