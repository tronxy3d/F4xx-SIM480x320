 ...
 */
  ...
  #elif (!defined(I_MIN_POS) || !defined(I_MAX_POS)) && !TAOLI_SERIAL
    #error "I_MIN_POS and I_MAX_POS are required with LINEAR_AXES >= 4."
  #elif !defined(I_HOME_DIR) && !TAOLI_SERIAL
...
// A machine with endstops must have a minimum of 3
  ...
  // Delta and Cartesian use 3 homing endstops
    ...
    #elif LINEAR_AXES >= 4 && I_HOME_TO_MIN && DISABLED(USE_IMIN_PLUG) && !TAOLI_SERIAL
