  ...
  private:
    static void postprocess();
      ...
      static void EEPROM_WRITE(const T &VAR) {
        ...
        persistentStore.write_data(eeprom_index, (const uint8_t *) &VAR, sizeof(VAR));
        #else
      ...
      static void EEPROM_READ(T &VAR) {
        #ifdef EEPROM_AT24CXX
        persistentStore.read_data(eeprom_index, (uint8_t *) &VAR, sizeof(VAR));
        #else
      ...
      static void EEPROM_READ(uint8_t *VAR, size_t sizeof_VAR) {
        #ifdef EEPROM_AT24CXX
        persistentStore.read_data(eeprom_index, VAR, sizeof_VAR, !validating);
        #else
